...
try:
    # Try secrets, then env, then fallback to LOCAL URL for local testing
    API_URL = st.secrets.get("API_URL", os.environ.get("API_URL", LOCAL_URL))
except:
    API_URL = os.environ.get("API_URL", LOCAL_URL)
